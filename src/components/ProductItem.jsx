...
import SpotlightCard from "./Animations/Components/SpotlightCard/SpotlightCard";
...
const ProductItem = ({ id, image, name, price, colors }) => {
  ...
  return (
    ...
    <Link to={`/product/${id}`} className="text-gray-700">
      ...
      >
        {/* Product Image */}
        <Image src={image[0]} alt={name} boxSize="100%" objectFit="cover" />
